...
//    }
    ...
    protected void initialize() {
        ...
        inflect.addPluralize("(buffal|tomat|ech|embarg|her|potat|torped|vet)o$", "$1oes");
        ...
        inflect.addPluralize("(matr|vert|ind|append)ix|ex$", "$1ices");
        ...
        inflect.addSingularize("^(is)$", "are");
        inflect.addSingularize("^(was)$", "were");
        inflect.addSingularize("^(has)$", "have");
        ...
        inflect.addIrregular("addendum", "addenda");
        inflect.addIrregular("alumnus", "alumni");
        inflect.addIrregular("alga", "algae");
        inflect.addIrregular("amoeba", "amoebae");
        inflect.addIrregular("antenna", "antennae");
        inflect.addIrregular("cactus", "cacti");
        inflect.addIrregular("curriculum", "curricula");
        inflect.addIrregular("fungus", "fungi");
        inflect.addIrregular("larva", "larvae");
        inflect.addIrregular("memorandum", "memoranda");
        inflect.addIrregular("stimulus", "stimuli");
        inflect.addIrregular("syllabus", "syllabi");
        inflect.addIrregular("vertabra", "vertabrae");

        inflect.addIrregular("leaf", "leaves");
        inflect.addIrregular("hoof", "hooves");
